...
define([
    ...
    'use strict';
    // This node should have three attributes
    // code/language/schemaURI (which can be null for non-existent schemas).
    const DEFAULT_CODE_NODE_TYPE = 'CodeNode';
    ...
    MonacoEditorControl.prototype._getObjectDescriptor = function (nodeId) {
        ...
        if (node && this.isCodeNodeType(node)) {
            objDescriptor = {
                ...
                schemaURI: node.getAttribute('schemaURI')
            };
        }
    ...
    MonacoEditorControl.prototype.isCodeNodeType = function (node) {
        ...
        return base && base.getAttribute('name') === DEFAULT_CODE_NODE_TYPE;
    };
